...
## [Mathematical background](#Mathematical-background)[]()[](#Mathematical-background)
...
## [Floquet periodic boundary conditions](#Floquet-periodic-boundary-conditions)[]()[](#Floquet-periodic-boundary-conditions)
...
## [Time domain formulation](#Time-domain-formulation)[]()[](#Time-domain-formulation)
...
## [Eigenmode calculations](#Eigenmode-calculations)[]()[](#Eigenmode-calculations)
...
## [Lumped ports and wave ports](#Lumped-ports-and-wave-ports)[]()[](#Lumped-ports-and-wave-ports)
...
\[\bm{U}^{inc} = -2 Z_s^{-1}\left(\bm{n}\times\frac{\partial\bm{E}^{inc}}{\partial t}\right)     \times\bm{n} \,.\]
...
## [Other boundary conditions](#Other-boundary-conditions)[]()[](#Other-boundary-conditions)
...
## [Energy-participation ratios](#Energy-participation-ratios)[]()[](#Energy-participation-ratios)
...
*Rectangular ports*: $\overline{V}_{mj} = \frac{1}{w_j}\int_{\Gamma_j}\bm{E}_m\cdot\hat{\bm{l}}_j\,dS$.

2. 

*Coaxial ports*: $\overline{V}_{mj} = \frac{1}{2\pi}\int_{\Gamma_j}\frac{\bm{E}_m}{r}\cdot\hat{\bm{r}}_j\,dS$.
...
## [Bulk and interface dielectric loss](#Bulk-and-interface-dielectric-loss)[]()[](#Bulk-and-interface-dielectric-loss)
...
The above formula for interface dielectric loss can be specialized for the case of a metal-air, metal-substrate, or substrate-air interface [[4]](#References). In each case, the quality factor for interface $j$ is given by
...
## [Lumped parameter extraction](#Lumped-parameter-extraction)[]()[](#Lumped-parameter-extraction)
...
## [Error estimation and adaptive mesh refinement (AMR)](#Error-estimation-and-adaptive-mesh-refinement-(AMR))[]()[](#Error-estimation-and-adaptive-mesh-refinement-(AMR))
...
## [Far-field extraction](#Far-field-extraction)[]()[](#Far-field-extraction)
...
#### [How to obtain the equation above from Stratton-Chu's original equations](#How-to-obtain-the-equation-above-from-Stratton-Chu's-original-equations)[]()[](#How-to-obtain-the-equation-above-from-Stratton-Chu's-original-equations)
...
[1] J.-M. Jin, *The Finite Element Method in Electromagnetics*, Wiley-IEEE Press, Hoboken, NJ, Third edition, 2014.
