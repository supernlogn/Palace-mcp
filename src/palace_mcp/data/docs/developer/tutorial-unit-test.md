# [Tutorial: Adding a New Unit Test](#Tutorial:-Adding-a-New-Unit-Test)[]()[](#Tutorial:-Adding-a-New-Unit-Test)

This tutorial demonstrates how to add unit tests to the *Palace* test suite. Prerequisites: familiarity with compiling and running unit tests (see [Running unit tests](../testing/#Running-unit-tests)).

## [Overview](#Overview)[]()[](#Overview)

As a motivating example, we'll test the `Sum(MPI_Comm comm, Vector& vec)` function. This function has certain characteristics that make it interesting to test:
